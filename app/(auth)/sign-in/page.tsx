    ...
    >
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <motion.div
          ...
          className="flex items-center justify-between mt-1 text-sm font-sans"
        >
          <label className="flex items-center gap-2 select-none group cursor-pointer">
            <input
              type="checkbox"
              checked={rememberMe}
              onChange={(e) => setRememberMe(e.target.checked)}
              className="w-4 h-4 rounded border-[var(--border)] bg-[var(--bg-surface)] text-[var(--accent)] focus:ring-[var(--accent)] cursor-pointer"
            />
            <span className="text-sm text-[var(--text-secondary)] group-hover:text-[var(--text-primary)] transition-colors">
              Remember me
            </span>
          </label>
          <Link href="#" className="text-[var(--accent)] hover:text-[var(--accent-hover)] font-medium transition-colors">
            Forgot password?
          </Link>
        </motion.div>
      ...
      <div className="mt-6 text-center text-sm">
        ...
        <Link href="/sign-up" className="text-[var(--accent)] hover:text-[var(--accent-hover)] font-medium font-sans transition-colors pl-1">
          Sign up
        </Link>
      </div>
    </motion.div>
